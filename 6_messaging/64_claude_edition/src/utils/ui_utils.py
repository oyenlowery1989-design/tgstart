...
"""
FILE: src/utils/ui_utils.py
PURPOSE: UI helper functions using the Rich library for beautiful terminal output.
IMPROVEMENTS: Internalized to make the project self-contained.
"""
