    ...
    async def register(self):
        ...
        async def participant_handler(event):
            try:
                ...
                if new_participant and isinstance(new_participant, types.ChannelParticipantAdmin):
                    # User was promoted to admin
                    if not old_participant or not isinstance(old_participant, types.ChannelParticipantAdmin):
                ...
                elif old_participant and isinstance(old_participant, types.ChannelParticipantAdmin):
                    if not new_participant or not isinstance(new_participant, types.ChannelParticipantAdmin):
                ...
                # Check for ban
                elif new_participant and isinstance(new_participant, types.ChannelParticipantBanned):
                ...
                elif old_participant and isinstance(old_participant, types.ChannelParticipantBanned) and \
                     new_participant and not isinstance(new_participant, types.ChannelParticipantBanned):
