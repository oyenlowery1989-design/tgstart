...
USAGE:
------
1. Install dependencies: pip install telethon opentele tgcrypto-pyrofork
2. Edit SESSION_NAME below to choose which session to convert
3. Run: python convert_session.py
"""
...
# Choose which session to convert (without .session extension)
# Available sessions: americandreamer8, AndreyKurennykh, TonkinStuart
...
async def main():
    ...
    if not deps_ok:
        ...
        logger.error("Run: pip install telethon opentele tgcrypto-pyrofork")
        return
    ...
    if not os.path.exists(session_file_path):
        ...
        logger.error("  - sessions/americandreamer8")
        logger.error("  - sessions/AndreyKurennykh")
        logger.error("  - sessions/TonkinStuart")
        return
